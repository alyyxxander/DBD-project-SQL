...
CREATE OR REPLACE TABLE GAME(
    ...
    VALUES(1,2,"SUPER MARIO ODYSSEY","PLATFORMER","10272017","96"),
...
CREATE OR REPLACE TABLE PLATFORM(
    ...
    VALUES(1,"PC",12346,77776)
    VALUES(2,"Switch",23431,88811)
    VALUES(3,"Xbox Series X",97241,66242)
    VALUES(4,"PS5",78414,44432)
    VALUES(2,"Switch",98124,33323)
);
...
CREATE OR REPLACE TABLE FORUM(
    ...
    VALUES(34,"I AM STUCK, HELP ME","I AM CURRENTLY STUCK IN THIS GAME BECAUSE OF STUFF. TELL ME HOW YOU BEAT IT.",12346,4646,1,"04052023")
);
